...
public class ChatBotServiceImpl implements ChatbotService {
    ...
    String GEMINI_API_KEY="AIzaSyBILdLtXYguAngsF4D7PGiryfmzJFUITlY";
    ...
    public CoinDto makeApiRequest ( String currencyName) throws Exception {
        ...
        ResponseEntity<Map> responseEntity = restTemplate.getForEntity(url, Map.class);   //after looking at the api res, we get to know that its a map, hence this Map entity
